...
ips=$( cat ./iplist.txt)
cmd="bash -c 'nmap -sS -sU -T4 -A -v -PE -PP -PS80,443 -PA3389 -PU40125 -PY -g 53 --script 'default or (discovery)' '$ips' > $HOME/enumresults/$ips/nmap.txt';bash"
for output in $( cat ./iplist.txt )
 do
    ...
    #nmap -sS -sU -T4 -A -v -PE -PP -PS80,443 -PA3389 -PU40125 -PY -g 53 --script "default or (discovery)" "$output" > $HOME/enumresults/$output/nmap.txt
